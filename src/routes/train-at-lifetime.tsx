...
export const Route = createFileRoute("/train-at-lifetime")({
  head: () => ({
    meta: [
      { title: "Train at Life Time Coral Gables — Eastern Movement" },
      {
        name: "description",
        content:
          "Life Time Coral Gables members: request a complimentary consultation with Eastern Movement and start training with intent.",
      },
      {
        property: "og:title",
        content: "Train at Life Time Coral Gables — Eastern Movement",
      },
      {
        property: "og:description",
        content:
          "Performance training for Life Time Coral Gables members. Submit your inquiry to schedule a consultation.",
      },
    ],
  }),
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      toast.error("Something went wrong", {
        description: "Please try again, or email hello@easternmovement.com directly.",
      });
    } finally {
      setSubmitting(false);
    }
